            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">Adalah aplikasi berbasis web dan mobile yang bergerak dibidang kesehatan khususnya perawat. Pada website HealthCare ini hanya admin yang dapat memanejemen, sedangkan pada mobile yang dapat menggunakan perawat dan pasien yang ingin melakukan konsultasi penyakit ke perawat sesuai penyakit pasien yang sedang di alami</p>
                        <div class="row g-3 mb-4">
                            <div class="col-12 d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>Rencana kedepannya untuk aplikasi kami yaitu mengembangkan fitur yang mungkin belum ada dan dapat digunakan seluruh puskesmas yang ada di Bondowoso</span>
                                </div>
                            </div>
                            <!--<div class="col-12 d-flex">
                                <div class="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>Website CliniCare dikembangkan oleh mahasiswa Teknik Informatika, Politeknik Negeri Jember Kampus Bondowoso. Website ini bertujuan untuk mempermudah masyarakat Bondowoso untuk mengkonsultasikan kesehatan mereka</p>
