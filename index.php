...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.html" class="navbar-brand p-0">
                    <!-- <img src="img/logoWhite.png" alt="Logo" style="height: 5rem;"> -->
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">HealthCare</h1>
                            <p class="text-white pb-3 animated zoomIn">HealthCare merupakan aplikasi dibidang kesehatan yang dapat menangani para pasien jika ingin berkonsultasi tentang penyakit yang sedang di alami</p>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h2 class="mb-4">HealthCare</h2>
                        <p class="mb-4">Adalah aplikasi berbasis web dan mobile yang bergerak dibidang kesehatan khususnya perawat. Pada website HealthCare ini hanya admin yang dapat memanejemen, sedangkan pada mobile yang dapat menggunakan perawat dan pasien yang ingin melakukan konsultasi penyakit kepada perawat.</p>
                        <div class="row g-3 mb-4">
                            <div class="col-12 d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span>Rencana kedepannya untuk bisnis aplikasi kami yaitu mengembangkan fitur yang mungkin belum ada agar dapat digunakan seluruh puskesmas yang ada di Bondowoso.</span>
                                </div>
                            </div>
                            <!--<div class="col-12 d-flex">
                                <div class="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
        ...
        <div class="container-xxl py-6">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <div class="d-inline-block border rounded-pill text-primary px-4 mb-3">Perawat</div>
                    <h2 class="mb-5">Daftar Perawat</h2>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <h5>Fara Derliana</h5>
                            <p class="mb-4">Bondowoso</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="img/team-1.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href="www.facebook.com"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Jl. Raya Situbondo, Blindungan, Kec. Bondowoso, Kabupaten Bondowoso, Jawa Timur 68211</p>
                        <p><i class="fa fa-phone-alt me-3"></i>+62 852 3347 1839</p>
                        <p><i class="fa fa-envelope me-3"></i>healthcare@gmail.com</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>Website HealthCare dikembangkan oleh mahasiswa Teknik Informatika, Politeknik Negeri Jember Kampus Bondowoso. Website ini bertujuan untuk mempermudah masyarakat Bondowoso untuk mengkonsultasikan kesehatan mereka</p>
                        <!--<div class="position-relative w-100 mt-3">
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">HealthCare</a>, All Right Reserved. 
