                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="card mb-3 mx-auto" style="height: 430px; width: 400px;">
                            <center>
                                <img src="../../img/dokter.png" class="card-img-top" style="height: 200px; width : 200px;">
                            </center>
                            <div class="card-body">
                                                ...
                                                <form method="POST">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nama" class="form-control" id="nama_perawat" placeholder="Nama Perawat" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Email Perawat</label>
                                                            <input type="email" name="email" class="form-control" id="email" placeholder="Email Perawat">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputPassword1">Nomor STR</label>
                                                            <input type="number" name="no_str" class="form-control" id="nostr" placeholder="Nomor STR">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-sm-12" data-select2-id="45">
                                                                <div class="form-group" data-select2-id="44">
                                                                    <label>Poli</label>
                                                                    <select name="id" id="id_poli" class="form-control select2 select2-danger select2-hidden-accessible" data-dropdown-css-class="select2-danger" style="width: 100%;" data-select2-id="23" tabindex="-1" aria-hidden="true">
                                                                        <?php
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="btn" id="btn_submit" class="btn btn-success swalDefaultSuccess">
                                                            Simpan
                                                        </button>
                                                    </div>
                                                </form>
