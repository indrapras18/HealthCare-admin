        ...
        <div class="row">
            ...
            <div class="col-md-6" style="margin-left: 95px;">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12"><label class="labels">Username</label><input type="text" class="form-control" placeholder="" value="<?= $rows['username']; ?>"></div>
                        <div class="col-md-12"><label class="labels">Email</label><input type="text" class="form-control" placeholder="" value="<?= $rows['email']; ?>"></div>
                        <div class="col-md-12"><label class="labels">Password</label><input type="Password" class="form-control" placeholder="" value="<?= $rows['password']; ?>"></div>
                        <br>
                        <br>
                        <br>
                        <div class="button mt-5 text-right">
                            ...
                            <button type="submit" class="btn btn-primary profile-button" name="btn"><i class="fa-solid fa-floppy-disk"></i><a href="../dashboard.php" style="color: white; text-decoration:none;"> Simpan</a></button>
                        </div>
                    </div>
                </div>
            </div>
